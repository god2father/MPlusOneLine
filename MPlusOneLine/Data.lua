...
addon.raidBosses = {
  ...
  { name = "The Twin Fangs", source = "method-twin-fangs", tips = { LFR = "已核验共通机制：避开会叠永恒毒液的技能；小怪优先击杀，石破必须安排人承受。", Normal = "已核验共通机制：避开会叠永恒毒液的技能；小怪优先击杀，石破必须安排人承受。", Heroic = "已核验共通机制：避开会叠永恒毒液的技能；小怪优先击杀，石破必须安排人承受。", Mythic = "已核验共通机制：避开会叠永恒毒液的技能；小怪优先击杀，石破必须安排人承受。" } },
  { name = "The Coiled Altar", source = "method-index-coiled-altar", tips = { LFR = "通用安全提醒：先按团队标记站位；出现首领预警后优先处理当前指定目标，并以冒险指南为准。", Normal = "通用安全提醒：先按团队标记站位；出现首领预警后优先处理当前指定目标，并以冒险指南为准。", Heroic = "通用安全提醒：先按团队标记站位；出现首领预警后优先处理当前指定目标，并以冒险指南为准。", Mythic = "通用安全提醒：先按团队标记站位；出现首领预警后优先处理当前指定目标，并以冒险指南为准。" } },
  { name = "Ula'tek", source = "method-index-ulatek", tips = { LFR = "通用安全提醒：先按团队标记站位；出现首领预警后优先处理当前指定目标，并以冒险指南为准。", Normal = "通用安全提醒：先按团队标记站位；出现首领预警后优先处理当前指定目标，并以冒险指南为准。", Heroic = "通用安全提醒：先按团队标记站位；出现首领预警后优先处理当前指定目标，并以冒险指南为准。", Mythic = "通用安全提醒：先按团队标记站位；出现首领预警后优先处理当前指定目标，并以冒险指南为准。" } },
}
